...
<html>
<head>
<title>Mulia Jaya Minimarket</title>
<!-- for-mobile-apps -->
		...
		<ul id="demo1">
			<li>
				...
				<div class="slide-desc">
					<h3>Dapatkan Harga Terbaik Hanya di Mulia Jaya Minimarket</h3>
				</div>
			</li>
			<li>
				<img src="images/22.jpg" alt="" />
				  <div class="slide-desc">
					<h3>Dengan Mulia Jaya Minimarket Semua Tersedia</h3>
				</div>
			</li>
			...
			<div class="grid_3 grid_5">
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					<ul id="myTab" class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="#expeditions" id="expeditions-tab" role="tab" data-toggle="tab" aria-controls="expeditions" aria-expanded="true">Diskon Minggu Ini</a></li>
						<li role="presentation"><a href="#tours" role="tab" id="tours-tab" data-toggle="tab" aria-controls="tours">Paket Menarik</a></li>
					</ul>
